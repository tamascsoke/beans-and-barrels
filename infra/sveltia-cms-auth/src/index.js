/**
 * Sveltia CMS GitHub OAuth proxy (from https://github.com/sveltia/sveltia-cms-auth)
 * Deploy to Cloudflare Workers — see docs/cms-oauth-setup.md
 */
...
export default {
  async fetch(request, env) {
    ...
    if (method === 'GET' && ['/auth', '/oauth/authorize', '/api/auth'].includes(pathname)) {
